...
public class ImageEntryRender extends EntryRender {
    ...
    public void render(GuiGraphics pGraphics, RegistryAccess pAccess, int pEntryX, int pEntryY, int pMouseX, int pMouseY, IEntry pEntry, IBook pBook, IModScreen pScreen, Font pFont) {
        ...
        super.render(pGraphics, pAccess, pEntryX, pEntryY, pMouseX, pMouseY, pEntry, pScreen, pBook, pFont);
    }
